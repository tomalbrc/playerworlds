...
public class HelpCommand {
	...
	static void init(CommandDispatcher<ServerCommandSource> dispatcher) {
		dispatcher.register(literal("world").then(literal("help").requires(Permissions.require("playerworlds.help", true)).executes(context -> {
	...
	static void run(ServerPlayerEntity player) {
		...
		String text = "";
		String key = "message.playerworlds.help.";
