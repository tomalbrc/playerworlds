...
public class PlayerworldsTexts {
	public static String prefixTranslationKey = "message.playerworlds.prefix";

	public static void prefixed(CommandContext<ServerCommandSource> context, String key, Consumer<Map<String, String>> builder) {
		context.getSource().sendFeedback(() -> PlayerworldsTexts.prefixed(key, builder), false);
	}

	public static void prefixed(PlayerEntity player, String key, Consumer<Map<String, String>> builder) {
		player.sendMessage(PlayerworldsTexts.prefixed(key, builder));
	}
